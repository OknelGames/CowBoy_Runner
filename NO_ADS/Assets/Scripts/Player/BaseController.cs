...
public class BaseController : MonoBehaviour
{
    ...
    public float minSwipeDistance = 50f; // Минимальная длина свайпа для распознавания
    public float maxSpeedModifier = 2f; // Максимальный множитель скорости
    ...
    {
        speed = new Vector3(-x_Speed / 1.25f, 0f, speed.z);
    }
    ...
    // Обработка сенсорного ввода для свайпов


    // Update is called once per frame
    void Update()
    {
        //HandleTouchInput();  // Обрабатываем сенсорный ввод
    }
}